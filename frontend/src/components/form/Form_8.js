                ...
                <Row>
                    ...
                    <span>
                        <Form.Item>
                            ...
                            {getFieldDecorator('f1_student_postcode', {rules: [{ required: true, message: 'กรุณากรอก JOB NO.' }],})( <Input className="event-input" style={{width: '26%'}}  placeholder="" />)}
                            <br/>
                            ...
                            <Form.Item>
                                ...
                                <div className="sup-set">
                                    ...
                                    <div className="sup-score-box">
                                        ...
                                        {getFieldDecorator('f1_student_postcode', {rules: [{ required: true, message: 'กรุณากรอก ชื่อ-นามสกุล' }],})( <Input className="sup-score-input" placeholder="" />)}
                                    </div>
                                </div>
                                {/* 2 */}
                                <div className="sup-set">
